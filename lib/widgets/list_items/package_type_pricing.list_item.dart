    ...
    return VStack([
          VStack([
            HStack([
              //
              CustomImage(
                imageUrl: packageTypePricing.packageType.photo,
              ).wh(Vx.dp64, Vx.dp64).box.clip(Clip.antiAlias).roundedSM.make(),
              ...
              VStack([
                ...
                //name
                "${packageTypePricing.packageType.description}".text.light
                    .maxLines(2)
            ...
            HStack(
              [
                ...
                VStack([
                  ...
                  //description
                  "${packageTypePricing.maxBookingDays}".text.lg.semiBold
                      .make(),
                ]).expand(),
              ],
              crossAlignment: CrossAxisAlignment.start,
