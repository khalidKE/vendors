                  ...
                  child:
                      VStack([
                        ...
                        VxBox(
                            ...
                            .bottomRounded(value: Sizes.radiusDefault)
                        ...
                        VStack([
                          ...
                          orderSection(OrderDetailsItemsView(vm), context),

                          //attachements
                          if (vm.order.attachments != null &&
                              vm.order.attachments!.isNotEmpty)
                            orderSection(OrderAttachmentView(vm), context),
                              ...
                              VStack([
                                HStack([
                                  ...
                                  VStack([
                                    ...
                                    (vm.order.driver?.name ?? "").text.medium.xl
                                        .make()
