    ...
    return Order(
      ...
      pickupDate: json["pickup_date"] != null
          ? Jiffy.parseFromDateTime(
                  DateFormat("yyyy-MM-dd", "en").parse(json["pickup_date"]))
              .format(pattern: "dd MMM, yyyy")
          : "",
      // pickupTime: "${json["pickup_date"]} ${json["pickup_time"] ?? '00:00:00'}",
      pickupTime: json["pickup_time"] != null
          ? Jiffy.parseFromDateTime(DateFormat("yyyy-MM-dd hh:mm:ss", "en").parse(
                  "${json["pickup_date"]} ${json["pickup_time"] ?? '00:00:00'}"))
